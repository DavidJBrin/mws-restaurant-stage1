...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/js/restaurant_info.js");
/******/ })
/************************************************************************/
/******/ ({
...
var DBHelper = function () {
  ...
  _createClass(DBHelper, null, [{
    ...
    value: function openDatabase() {
      ...
      this.DBPromised = _idb2.default.open('mws-restaurants', 1, function (upgradeDb) {
    ...
    value: function fetchRestaurants(callback) {
      ...
      fetch(DBHelper.DATABASE_URL).then(function (response) {
        ...
        return response.json().then(function (json) {
          DBHelper.DBPromised.then(function (db) {
            if (!db) return;
    ...
    key: 'imageExtForURL',
    value: function imageExtForURL(URL) {
...
__webpack_require__(/*! ./leaflet */ "./src/js/leaflet.js");
 ...
 */
_dbhelper2.default.openDatabase();
  ...
  fetchRestaurantFromURL(function (error, restaurant) {
    if (error) {
      ...
      L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.jpg70?access_token={mapboxToken}', {
        mapboxToken: "pk.eyJ1IjoicnVud2l0aGdyZWciLCJhIjoiY2prbGxsd3FxMjJkczNxbWwxZDMxbGg3ZyJ9.4CWWTQd5xyyCFyFxf1nsmw",
        maxZoom: 18,
        id: 'mapbox.streets'
      }).addTo(self.newMap);
      fillBreadcrumb();
...
var fillRestaurantHTML = function fillRestaurantHTML() {
  ...
  var imageURL = _dbhelper2.default.imageUrlForRestaurant(restaurant);
  var imageExt = _dbhelper2.default.imageExtForURL(imageURL);
